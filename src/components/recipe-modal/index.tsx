...
export const RecipeModal = () => {
  ...
  const { label, image, ingredients, ingredientLines } = recipe;
  ...
  return (
    <div className="bg-gray-950/25 fixed w-screen h-screen top-0 left-0 flex items-center justify-center">
      <div className="w-[40rem] h-[45rem] max-h-[90vh] max-w-[95vw] animate-scale-up flex flex-col shadow rounded-xl bg-gradient-to-t from-gray-900 to-blue-950">
        ...
        <div className="flex-grow px-3 overflow-auto flex flex-col w-full">
          ...
          <div className="pt-5">
            <h5 className="text-xl text-center">Directions:</h5>
            <ul>
